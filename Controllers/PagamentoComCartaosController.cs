...
namespace TrabalhoFinal.Controllers
{
    public class PagamentoComCartaosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NumeroDoCatao,Bandeira,NomeDocobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NumeroDoCatao,Bandeira,NomeDocobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
