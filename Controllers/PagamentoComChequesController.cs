...
namespace TrabalhoFinal.Controllers
{
    public class PagamentoComChequesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Banco,NomeDoBanco,NomeDocobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Banco,NomeDoBanco,NomeDocobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
